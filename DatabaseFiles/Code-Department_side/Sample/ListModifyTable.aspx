...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnConfirm" runat="server" Text="Add New Employee" PostBackUrl="ModifyTable.aspx" Width="200px" Height="30px" style="margin-left: 170px" BackColor=""/>
            ...
            <asp:GridView ID="gvPhoneBook" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="MailID"
                ...
                BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" OnSelectedIndexChanged="gvPhoneBook_SelectedIndexChanged" Width="1200px" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center">
                <%-- Theme Properties --%>
